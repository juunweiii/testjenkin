...
const ModeratorDashboard = () => {
    ...
    const fetchUsers = async () => {
        try {
            ...
            const filteredUsers = allUsers.filter(listUser => listUser.usersId !== user.usersId && listUser.role !== 'admin' && listUser.role !== 'moderator');
    ...
    return (
        <>
            ...
            <Container className='mod-dashboard-container'>
